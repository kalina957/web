    ...
    <div class="container">
        ...
        <div class="row-wrapper">
            <div class="info-wrapper">
                <img src="salewatch.png" alt=""  class="myImg">
            ...
            <div class="info-wrapper">
                <img src="salewatch1.png" alt="" class="myImg">
                <div class="text-wrapper">
            ...
            <div class="info-wrapper">
                <img src="salewatch2.png" alt=""  class="myImg">
                <div class="text-wrapper">
        ...
        <div class="row-wrapper">
            <div class="info-wrapper">
                <img src="salewatch3.png" alt=""  class="myImg">
                <div class="text-wrapper">
            ...
            <div class="info-wrapper">
                <img src="salewatch4.png" alt=""  class="myImg">
                <div class="text-wrapper">
            ...
            <div class="info-wrapper">
                <img src="salewatch5.png" alt="" class="myImg">
                <div class="text-wrapper">
